...
function SubjectPage() {
    ...
    return (
        <div className="flex flex-col min-h-screen">
            ...
            <div className="subject-cards grid grid-cols-1 sm:grid-cols-2 gap-6 p-6">
                {subjects.map((subject) => (
                    <div
                        key={subject.id}
                        className={`subject-card p-6 rounded-lg shadow-lg cursor-pointer transform transition-transform duration-300 hover:scale-105 hover:shadow-2xl bg-gradient-to-r from-green-400 to-blue-500 text-white`}
